...
const nav = (options) => {
  ...
  const admin_nav = [
    ...
    //   meta: { title: '用户管理', keepAlive: true, icon: 'dashboard', permission: ['dashboard'] },
    // },
    // {
    //   parentId: 1,
    //   id: 11,
    ...
    },
    {
      ...
      meta: { title: '用户组管理', keepAlive: true, permission: ['dashboard'] },
    },
    {
      parentId: 0,
      id: 6,
    ...
    },
    {
      parentId: 0,
      id: 7,
      path: '/modlestoremanager',
      name: 'modlestoremanager',
      component: 'modlestoremanager',
      meta: { title: '模型库管理', keepAlive: true, permission: ['dashboard'] },
    },
    {
      parentId: 0,
      id: 8,
      ...
      meta: { title: '数据源管理', keepAlive: true, permission: ['dashboard'] },
    },
    {
      parentId: 0,
      id: 10024,
